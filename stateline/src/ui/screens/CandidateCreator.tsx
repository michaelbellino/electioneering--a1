...
import { fmtPosition, fmtScore } from '@ui/format'
  ...
  return (
    <div>
      <div className="page-head">
        <span className="kicker">New Campaign</span>
        <h2>Build your campaign</h2>
        <p className="muted">Who you are, and where you stand — the electorate will judge both.</p>
      </div>
      <div className="creator">
        <div className="panel">
          <h3>Your Candidate</h3>
          ...
          <h4 className="subhead">Attributes</h4>
          <Slider label="Charisma" value={attrs.charisma} min={0} max={1} format={fmtScore} onChange={setAttr('charisma')} />
          <Slider label="Competence" value={attrs.competence} min={0} max={1} format={fmtScore} onChange={setAttr('competence')} />
          <Slider label="Integrity" value={attrs.integrity} min={0} max={1} format={fmtScore} onChange={setAttr('integrity')} />
          <Slider label="Fundraising" value={attrs.fundraising} min={0} max={1} format={fmtScore} onChange={setAttr('fundraising')} />
        </div>
