...
export const CAMPAIGN_ACTIONS: readonly CampaignActionDef[] = [
  {
    ...
    effects: [
      { channel: 'nameRecognition', target: 'self', magnitude: 0.5, rampDurationDays: 3, decayHalfLifeDays: 30 },
  ...
  },
  {
    ...
    amplifiedBy: 'comms_director',
    effects: [
      { channel: 'favorability', target: 'self', magnitude: 0.06, rampDurationDays: 2, decayHalfLifeDays: 18, tone: 0.5 },
      { channel: 'nameRecognition', target: 'self', magnitude: 0.15, rampDurationDays: 2, decayHalfLifeDays: 20 },
    ],
  },
  {
    id: 'canvass',
